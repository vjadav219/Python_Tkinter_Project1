...
def csv_A():    
    ...
    tmsg.showinfo("Download","Download Class A Successfully")
def csv_B():  
    global t 
    import pandas as pd
    import mysql.connector
    ...
    tmsg.showinfo("Download","Download Class B Successfully")
def csv_C():   
    global t
    import pandas as pd
    import mysql.connector
    ...
    tmsg.showinfo("Download","Download Class C Successfully")
def csv_D(): 
    global t
    import pandas as pd
    import mysql.connector
    ...
    tmsg.showinfo("Download","Download Class D Successfully")
